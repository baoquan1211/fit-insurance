...
const contractCreationSchema = z.object({
  ...
  name: z.string().min(4, { message: "Tên phải đầy đủ họ tên" }),
  birthdate: z.string(),
  gender: z.string(),
  phone: z
    .string()
    ...
    if (
      ...
      contractCreationSchema
        ...
        .then((data: ContractCreation) => {
          mutateAsync(data).then((contract) => {
  ...
  return (
    <main className="relative flex min-h-[calc(100dvh-72px)] w-full flex-col items-center bg-gray-100 px-3 py-6 md:py-16">
      <div>
        ...
        >
          <div className="flex flex-col rounded-lg bg-background p-6 md:min-w-max md:max-w-3xl">
          ...
          <div className="sticky bottom-0 left-0 flex h-fit w-full flex-col gap-4 rounded-lg bg-background p-3 md:max-w-xs md:p-6">
