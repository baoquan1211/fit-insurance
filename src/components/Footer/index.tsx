...
function Footer() {
  ...
  return (
    <footer className="items-center w-full pt-14 justify-center flex flex-col xl:px-0 px-6">
      <div className="max-w-3xl xl:max-w-5xl w-full justify-center flex flex-col py-2 border-b-2">
        ...
        <div className="flex justify-between w-full flex-col md:flex-row mt-6">
